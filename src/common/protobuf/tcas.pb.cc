...
void protobuf_AssignDesc_tcas_2eproto() {
  ...
  TcasReport_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1,
      sizeof(TcasReport),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TcasReport, _internal_metadata_),
      -1);
}
...
TcasReport* TcasReport::New(::google::protobuf::Arena* arena) const {
  TcasReport* n = new TcasReport;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
int TcasReport::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
void TcasReport::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const TcasReport* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const TcasReport>(
          &from);
  if (source == NULL) {
...
void TcasReport::InternalSwap(TcasReport* other) {
...
// required sfixed32 id = 1;
bool TcasReport::has_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void TcasReport::set_has_id() {
  _has_bits_[0] |= 0x00000001u;
}
void TcasReport::clear_has_id() {
  _has_bits_[0] &= ~0x00000001u;
}
void TcasReport::clear_id() {
  id_ = 0;
  clear_has_id();
}
 ::google::protobuf::int32 TcasReport::id() const {
  // @@protoc_insertion_point(field_get:TcasReport.id)
  return id_;
}
 void TcasReport::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
...
void TcasReport::set_has_range() {
  _has_bits_[0] |= 0x00000002u;
}
void TcasReport::clear_has_range() {
  _has_bits_[0] &= ~0x00000002u;
}
void TcasReport::clear_range() {
  range_ = 0;
  clear_has_range();
}
...
void TcasReport::set_has_altitude() {
  _has_bits_[0] |= 0x00000004u;
}
void TcasReport::clear_has_altitude() {
  _has_bits_[0] &= ~0x00000004u;
}
void TcasReport::clear_altitude() {
  altitude_ = 0;
  clear_has_altitude();
}
...
void TcasReport::set_has_bearing() {
  _has_bits_[0] |= 0x00000008u;
}
void TcasReport::clear_has_bearing() {
  _has_bits_[0] &= ~0x00000008u;
}
void TcasReport::clear_bearing() {
  bearing_ = 0;
  clear_has_bearing();
}
